...
st.set_page_config(page_title = "LangGraph Multi AI Agent", layout = "wide")
...
with st.container():
    ...
    with col2:
        st.text("")
        st.text("")
        original_title = '<h1 style="text-align: centre; font-family: serif; color:white; font-size: 32px;">LangGraph Multi-Agent AI</h1>'
